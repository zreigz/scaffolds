...
config.kubernetes.io/depends-on: infrastructure.cluster.x-k8s.io/namespaces/{{ .Release.Namespace }}/GCPManagedMachinePool/{{ .Values.cluster.name }}-small-burst-on-demand,infrastructure.cluster.x-k8s.io/namespaces/{{ .Release.Namespace }}/GCPManagedMachinePool/{{ .Values.cluster.name }}-medium-burst-on-demand,infrastructure.cluster.x-k8s.io/namespaces/{{ .Release.Namespace }}/GCPManagedMachinePool/{{ .Values.cluster.name }}-large-burst-on-demand,cluster.x-k8s.io/namespaces/{{ .Release.Namespace }}/MachinePool/{{ .Values.cluster.name }}-large-burst-on-demand,cluster.x-k8s.io/namespaces/{{ .Release.Namespace }}/MachinePool/{{ .Values.cluster.name }}-medium-burst-on-demand,cluster.x-k8s.io/namespaces/{{ .Release.Namespace }}/MachinePool/{{ .Values.cluster.name }}-small-burst-on-demand
{{- end }}
